...
export const MENU_ITEMS_DATA: IMenuItem[] = [
  ...
  { type: MenuItemTypeEnum.PLATFORM, iconUrl: '/media/icons/entities2.svg', routeUrl: '/test', title: 'Entities' },
...
export const CONSTANT_MENU_ITEMS: IMenuItem[] = [
  { iconUrl: '/media/icons/privacy.svg', routeUrl: '/', title: 'Privacy' },
  { iconUrl: '/media/icons/settings.svg', routeUrl: '/', title: 'Settings' },
];